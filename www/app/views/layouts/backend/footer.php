            ...
            <form id="form-login">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" required class="form-control" id="connexion-password" name="password" placeholder="<?= \NGine\Translate::get("nouveauprojet.login.password.placeholder"); ?>">
                    </div>
                </div>
...
<?= $this->renderJS(); ?>
<!-- Tabler Core -->
<script src="/assets/node_modules/@tabler/core/dist/js/tabler.min.js"></script>
